...
from source.datasets.shape_mol_dataset import ShapeMolDataset
...
import source.utils.train as utils_train
import source.utils.data as utils_data
from source.utils import analyze
from source.utils.reconstruct import reconstruct_from_generated, MolReconsError
from source.utils.eval_bond_length import get_pair_length_profile, eval_pair_length_profile, \
    plot_distance_hist, pair_distance_from_pos_v
from rdkit import Chem
import time
from sklearn.metrics import roc_auc_score
import pickle
from source.scripts.sample_diffusion_no_pocket import sample_diffusion_ligand
from source.utils.evaluation import compare_with_ref, Local3D
from source.utils import reconstruct
import pandas as pd
from source.utils import scoring_func
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='./config/training/diff_pos0_10_pos1.e-7_0.01_6_v001_bondTrue_scalar128_vec32_layer8.yml')
