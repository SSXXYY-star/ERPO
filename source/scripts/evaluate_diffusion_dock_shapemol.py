...
from source.utils import eval_bond_length
from source.utils import eval_atom_type
...
if __name__ == '__main__':
    ...
    parser.add_argument('--protein_root', type=str, default='./data/crossdocked/crossdocked_protein_new')
    ...
    parser.add_argument('--sample_path', type=str, default='./outputs_test_EGPO')
