...
def parse_rdkit_mol(rdmol, center=None):
    ...
    data = {
        ...
        'element': element,  # 原子序数列表
        'pos': pos,
        'bond_index': edge_index,  # 边索引，2*num_edges
        'bond_type': edge_type,
        'center_of_mass': center_of_mass,  # 质心坐标
        'atom_feature': feat_mat,
        'hybridization': hybridization,  # 杂化状态列表
        'center': center  # None
         #'shape_emb': shape_emb,
    }
    return data
